# [ISSUE](https://github.com/ROCm/ROCm/issues/5834)
...
|---------------|------|---------------|-----------------|
| Torch 2.1 | — | 26/35 | 36/42 |
| Torch 2.1 | --use-pytorch-cross-attention | 62 | 11 |
| Torch 2.9 | — | 28/38 | 60 |
...
# Zimage Torch 2.1 FLAG --use-pytorch-cross-attention
